...
./FreezeFramesDetector.py -url_file input_url_files/url_file.txt -out_videos_folder downloaded_files/  -in_videos_folder downloaded_files -analyzer_path ../../../ffmpeg-git-20191222-i686-static/ -out_logs_folder logs_folder -in_folder logs_folder  -out_json_file freeze_frames_log.json
